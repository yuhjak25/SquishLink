  ...
  return (
    <li className='text-white flex items-center justify-center gap-2 pl-4 transition-all '>
      ...
      <a
        ...
        className='underline decoration-0 transition-all delay-150 ease-in-out hover:-translate-y-0.5 hover:underline-offset-4 hover:text-vista'
      >
        {link.createdLink}
      </a>
      <button className='text-white transition delay-150 ease-in-out cursor-pointer hover:text-vista hover:scale-105 hover:border-transparent'>
        <svg
