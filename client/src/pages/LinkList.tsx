...
function LinkList() {
  ...
  if (!links || !links.length)
    return (
      <div className='flex flex-col items-center justify-center p-5 text-center text-white transition-opacity delay-300 ease-in opacity-90'>
  ...
  return (
    <div className='relative flex flex-col'>
      <p className='text-vista bg-vista/50 rounded p-1.25 text-[15.5px] font-medium self-end mt-4'>
        {links.length}/15
      </p>
